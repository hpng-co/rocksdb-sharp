...
{
    public class OptimisticTransaction : IDisposable
    {
        ...
        internal OptimisticTransaction(OptimisticTransactionDb parent, WriteOptions writeOptions, TransactionOptions transactionOptions)
        {
            References.Parent = parent;
            References.WriteOptions = writeOptions;
            References.TransactionOptions = transactionOptions;

            Handle = Native.Instance.rocksdb_optimistictransaction_begin(
                parent.Handle,
                writeOptions.Handle,
